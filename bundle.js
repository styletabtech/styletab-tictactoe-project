...
/***/ function(module, exports, __webpack_require__) {
	...
	var onSignUp = function onSignUp(event) {
	  ...
	  api.signUp(signUpData).done(function (data, textStatus, jqXHR) {
	    api.autoLogIn(data, textStatus, jqXHR, signUpData).done(ui.signInSuccess).fail(ui.failure);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onSquareClick = function onSquareClick(event) {
	  event.preventDefault();
	  var squareClicked = event.target.id;
	  logic.validMove(squareClicked);
	  logic.winCheck(squareClicked);
	  var index = $('#' + squareClicked).data("id");
	  var value = $('#' + squareClicked).html();
	  api.updateGame(index, value, logic.gameOver).done(ui.onUpdateSuccess).fail(ui.onError);
	};
	...
	var createNewGame = function createNewGame(event) {
	  ...
	  logic.newGameBoard();
	  var data = {};
	  api.newGame(data).done(ui.onSuccess).fail(ui.onError);
	};

	var onGetGames = function onGetGames(event) {
	  event.preventDefault();
	  api.getTotalGames(event).done(ui.onShowGamesTotal).fail(ui.onError);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var updateGame = function updateGame(index, value, game) {
	  return $.ajax({
	    method: 'PATCH',
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  ...
	  onShowGamesTotal: onShowGamesTotal
...
/***/ function(module, exports, __webpack_require__) {
	...
	var whoseTurn = function whoseTurn(squareClicked) {
	  if (turnCount % 2 === 0) {
	    ...
	    var _index = $('#' + squareClicked).data("id");
	    turnCounter();
	    currentBoard[_index] = 'o';
	  }
	};

	var validMove = function validMove(squareClicked) {
	...
	var catsGameMsg = function catsGameMsg() {
	  $('.draw-msg').show();
	  gameOver = true;
	};

	var winRow = function winRow() {
	  if (currentBoard[0] === currentBoard[1] && currentBoard[0] === currentBoard[2] && currentBoard[0] !== '' || currentBoard[3] === currentBoard[4] && currentBoard[3] === currentBoard[5] && currentBoard[3] !== '' || currentBoard[6] === currentBoard[7] && currentBoard[6] === currentBoard[8] && currentBoard[6] !== '') {
	    winMsg();
	  } else {
	    return false;
	  }
	...
	var winColumn = function winColumn() {
	  if (currentBoard[0] === currentBoard[3] && currentBoard[0] === currentBoard[6] && currentBoard[0] !== '' || currentBoard[1] === currentBoard[4] && currentBoard[1] === currentBoard[7] && currentBoard[1] !== '' || currentBoard[2] === currentBoard[5] && currentBoard[2] === currentBoard[8] && currentBoard[2] !== '') {
	    winMsg();
	  } else {
	    return false;
	  }
	...
	var winDiagonal = function winDiagonal() {
	  if (currentBoard[0] === currentBoard[4] && currentBoard[0] === currentBoard[8] && currentBoard[0] !== '' || currentBoard[2] === currentBoard[4] && currentBoard[2] === currentBoard[6] && currentBoard[2] !== '') {
	    winMsg();
	  } else {
	    catsGame();
	  }
	...
	var newGameBoard = function newGameBoard() {
	  $('.square').html('');
	  currentBoard = ['', '', '', '', '', '', '', '', ''];
	  turnCount = 0;
	  gameOver = 0;
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "82890077c314ef0a1663ddbd5b9c9719.jpg";
